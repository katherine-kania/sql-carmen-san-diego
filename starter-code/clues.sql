...
--San Marino
-- or --
SELECT * FROM countries JOIN countrylanguages ON countries.code = countrylanguages.countrycode WHERE language = 'Italian' AND isofficial = true AND precentage = 100;
...
SELECT name, countrycode FROM cities WHERE name LIKE 'Serr%' AND NOT name = 'Serravalle';
--Serra / BRA / BRAZIL
--or--
SELECT countries.name, countries.code FROM countries JOIN cities ON countries.code = cities.countrycode WHERE cities.name LIKE 'Serra%' AND countries.name != 'Serravalle'
